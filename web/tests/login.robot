...
Não deve logar com senha incorreta
    [Tags]    inv_pass
    Go to login page
    Submit login form    sac@smartbit.com    incorreta
    Toast shoul be    As credenciais de acesso fornecidas são inválidas. Tente novamente!

Não deve logar com email incorreta
    [Tags]    inv_email
    Go to login page
    Submit login form    404@smartbit.com    incorreta
    Toast shoul be    As credenciais de acesso fornecidas são inválidas. Tente novamente!
...
Tentativa de login com dados incorretos
    ...
    12312313            pwd123             Oops! O email informado é inválido
